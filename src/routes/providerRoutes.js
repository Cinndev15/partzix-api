 ...
 *     description: Permite registrar la información detallada del proveedor y subir los documentos requeridos (RUT, ID representante legal, Certificado Cámara de Comercio, foto de perfil y logotipo). Se debe enviar como Multipart Form Data.
 *     tags:
 ...
 *                 type: string
 *                 format: binary
 *                 description: Foto o selfie del registrante.
 *     responses:
 *       201:
 ...
 *       400:
 *         description: Faltan campos obligatorios, archivos o almacén no existe.
 *         content:
 *           application/json:
 *             schema:
