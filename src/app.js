...
const vehicleVersionRoutes = require('./routes/vehicleVersionRoutes');
...
app.use('/api/vehicle-versions', vehicleVersionRoutes);
app.use('/api/versions', vehicleVersionRoutes);
